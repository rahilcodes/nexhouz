                    ...
                    <div className="border-t border-[#EEE9E0] pt-3.5 flex items-center justify-between text-[11.5px] lg:text-xs font-bold uppercase tracking-widest text-[#948d7c]">
                      {property.type === "Plot" ? (
                        <>
                          ...
                          <span>Plot / Land</span>
                          <span className="text-[#e0d9cb]">|</span>
                          <span>{property.possession === "Ready" ? "Ready" : "Under Dev."}</span>
                        </>
                      ) : property.type === "Villa" ? (
                        <>
                          ...
                          <span className="text-[#e0d9cb]">|</span>
                          <span>{property.plotSize ? `${property.plotSize} ${property.plotSizeUnit || "Sq Yds"} Plot` : (property.possession === "Ready" ? "Ready" : "Under Constr.")}</span>
                        </>
                      ) : (
                        <>
                          <span>{property.bhk} BHK</span>
